...
namespace SpreadsheetTests
{
    ...
    public class UnitTest1
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////
        // this test code will only work if you have these files 'readTest.xml'.
        ////////////////////////////////////////////////////////////////////////////////////
#if false
        /// <summary>
        /// checks to see if the file loads in.
        /// </summary>
        [TestMethod]
        public void publicLoad_XMLFile()
        {
            Spreadsheet ss = new Spreadsheet("readTest.xml", s => true, n => n, "default");
        }

        /// <summary>
        /// checks to see if the file loads in. And then saves that file to SavedFile.xml
        /// </summary>
        [TestMethod]
        public void publicSpreadsheet_LoadSave()
        {
            Spreadsheet ss = new Spreadsheet("readTest.xml", s => true, n => n, "default");
            ss.Save("SavedFile.xml");
        }

        /// <summary>
        /// test what version you are on
        /// </summary>
        [TestMethod()]
        public void publicGetSavedVersion_findVesion()
        {
            Spreadsheet ss = new Spreadsheet("readTest.xml", s => true, n => n, "default");
            ss.Save("SavedFile.xml");
            string version = ss.GetSavedVersion("SavedFile.xml");
            Assert.AreEqual("default", version);
        }

        /// <summary>
        /// test the value of the current cell
        /// </summary>
        [TestMethod()]
        public void publicGetCellValue_assertValue()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "1");
            ss.SetContentsOfCell("B1", "hi");
            ss.SetContentsOfCell("C1", "=2+1");
            ss.SetContentsOfCell("D1", "=C1-A1");

            double answerD = (double)ss.GetCellValue("A1");
            string answerS = (string)ss.GetCellValue("B1");
            double answerF = (double)ss.GetCellValue("C1");
            double answerF2 = (double)ss.GetCellValue("D1");

            Assert.AreEqual(1, answerD);
            Assert.AreEqual("hi", answerS);
            Assert.AreEqual(3, answerF);
            Assert.AreEqual(2, answerF2);
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void publicSpreadsheet_LoadFail()
        {
            Spreadsheet ss = new Spreadsheet("aisoudgo.xml", s => true, n => n, "default");
            ss.Save("SavedFile.xml");
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void publicSpreadsheet_cellNameFail()
        {
            Spreadsheet ss = new Spreadsheet("cellNameFail.xml", s => true, n => n, "default");
        } 
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void publicSpreadsheet_VersionLoadFail()
        {
            Spreadsheet ss = new Spreadsheet("readTest.xml", s => true, n => n, "100.1");
        }

        [TestMethod]
        public void publicSetContentsOfCell_NormalizeName()
        {
            Spreadsheet ss = new Spreadsheet(x =>true, x => x.ToUpper(), "upperCase");
            ss.SetContentsOfCell("a1", "name should be capt");
            List<string> list = new List<string>(ss.GetNamesOfAllNonemptyCells());
            Assert.AreEqual("A1", list[0]);
        }

        [TestMethod]
        [ExpectedException(typeof(FormulaFormatException))]
        public void publicSetContentsOfCell_FormulaException()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=2+1-+1");
        }
        ...
        public void publicSetContentsOfCell_circularDependency()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("B2", "2");
            ss.SetContentsOfCell("C3", "2");
            ss.SetContentsOfCell("A1", "=B2+C3");
        ...
        /// <summary>
        /// test changed on string, double and formula
        /// </summary>
        [TestMethod()]
        public void publicChange_isChanged()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "1");
            Assert.AreEqual(true, ss.Changed);

            ss.Save("SaveTest.xml");
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicGetCellContents_null()
        {
            Spreadsheet ss = new Spreadsheet();
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicGetCellContents_invalid()
        {
            Spreadsheet ss = new Spreadsheet();
        ...
        /// <summary>
        /// check to see if you get a list of all none empty cells
        /// </summary>
        [TestMethod]
        public void publicGetNamesOfAllNonemptyCells()
        {
            Spreadsheet ss = new Spreadsheet();
            ...
            HashSet<string> scc = new HashSet<string>(ss.GetNamesOfAllNonemptyCells());
            ...
            Assert.AreEqual(true, compairHash(c, scc));
        }


        /// <summary>
        /// If formula is null, throws an ArgumentNullException.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void publicSetContentsOfCell_FormulaNull()
        {
            Spreadsheet ss = new Spreadsheet();
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_null()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell(null, "1+2");
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_invalid()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("@1a", "1+2");
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void publicSetCellContens_circularDependency()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("B2", "2");
            ss.SetContentsOfCell("C3", "1");
            ss.SetContentsOfCell("A1", "=B2+C3");
            ss.SetContentsOfCell("C3", "=A1+B2");
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void publicSetCellContens_circularDependency2()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("B2", "2");
            ss.SetContentsOfCell("C3", "2");
            ss.SetContentsOfCell("B3", "2");
            ss.SetContentsOfCell("A1", "=B2+C3");
            ss.SetContentsOfCell("C3", "=B3+2");
            ss.SetContentsOfCell("C3", "=A1+B2");
        }

        /// <summary>
        ///  test if the SetContentsOfCell gives a circular exception
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void publicSetCellContens_circularDependency3()
        {
            Spreadsheet ss = new Spreadsheet(x => true, x => x.ToUpper(), "upperCase");
            ss.SetContentsOfCell("A1", "2");
            ss.SetContentsOfCell("b1", "2");
            ss.SetContentsOfCell("E2", "2");
            ss.SetContentsOfCell("F2", "2");
            ss.SetContentsOfCell("Z2", "2");
            ss.SetContentsOfCell("K2", "2");
            ss.SetContentsOfCell("C1", "2");
            ss.SetContentsOfCell("D1", "=A1+B1");
            ss.SetContentsOfCell("A1", "=E2+F2");
            ss.SetContentsOfCell("B1", "=Z2+K2");
            ss.SetContentsOfCell("C1", "=D1+C1");
            ss.SetContentsOfCell("D1", "=A1+C1");
        }

        /// <summary>
        ///  test if the SetContentsOfCell gives a circular exception from deep depentent
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void publicSetCellContens_circularDependency4()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("N1", "2");
            ss.SetContentsOfCell("C1", "2");
            ss.SetContentsOfCell("D1", "2");
            ss.SetContentsOfCell("E2", "2");
            ss.SetContentsOfCell("A1", "=N1+1");
            ss.SetContentsOfCell("B1", "=N1+1");
            ss.SetContentsOfCell("N1", "=C1+D1");
            ss.SetContentsOfCell("C1", "=E2+1");
            ss.SetContentsOfCell("D1", "=E2+2");
            ss.SetContentsOfCell("E2", "=N1+C1");
        }

        /// <summary>
        ///  circular exception caused from variable in formula looping on its self.
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void publicSetCellContens_circularDependency6()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=A1+1");
        }
        /// <summary>
        /// look to see if SetContentsOfCell returns the correct set
        /// For example, if name is A1, B1 contains A1*2, and C1 contains B1+A1, the
        /// set {A1, B1, C1} is returned.
        /// </summary>
        [TestMethod]
        public void publicSetCellContens_recalculateSet()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=2+1");
            ss.SetContentsOfCell("B1", "=A1*2");
            ss.SetContentsOfCell("C1", "=B1+A1");
            HashSet<string> scc = new HashSet<string>(ss.SetContentsOfCell("A1", "2+1"));
        ...
        /// <summary>
        /// takes two hashsets and compairs them.
        /// </summary>
        /// <param name="c"></param>
        /// <param name="scc"></param>
        /// <returns></returns>
        private bool compairHash(HashSet<string> c, HashSet<string> scc)
        {
            int count = 0;
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void publicSetContentsOfCell_StringTextNull()
        {
            Spreadsheet ss = new Spreadsheet();
            string n = null;
            ss.SetContentsOfCell("A1", n);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_StringNameNull()
        {
            Spreadsheet ss = new Spreadsheet();
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_StringInvalid()
        {
            Spreadsheet ss = new Spreadsheet();
        ...
        /// </summary>
        [TestMethod]
        public void publicSetCellContens_recalculateText()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "1");
            ss.SetContentsOfCell("B1", "=A1*2");
            ss.SetContentsOfCell("C1", "=B1+A1");
            HashSet<string> scc = new HashSet<string>(ss.SetContentsOfCell("A1", "hi"));
        ...
        /// <summary>
        /// look to see if SetContentsOfCell sets the text to 
        /// </summary>
        [TestMethod]
        public void publicSetCellContens_recalculateTextAssert()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=2+1");
            ss.SetContentsOfCell("B1", "=A1*2");
            ...
            Assert.AreEqual("hi", ss.GetCellContents("A1").ToString());
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_DoubleNameNull()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell(null, "3.2");
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void publicSetContentsOfCell_DoubleNameInvalid()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("1A", "3.2");
        }
        ...
        /// </summary>
        [TestMethod]
        public void publicSetCellContens_recalculateDouble()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "3.2");
            ss.SetContentsOfCell("B1", "=A1*2");
            ss.SetContentsOfCell("C1", "=B1+A1");
            HashSet<string> scc = new HashSet<string>(ss.SetContentsOfCell("A1", "3.2"));
        ...
        /// <summary>
        /// look to see if SetContentsOfCell sets the text to 3.2
        /// </summary>
        [TestMethod]
        public void publicSetCellContens_recalculateDoubleAssert()
        {
            Spreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=2+1");
            ss.SetContentsOfCell("B1", "=A1*2");
            ...
            Assert.AreEqual((object)3.2, ss.GetCellContents("A1"));
